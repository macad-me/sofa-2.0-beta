...
const v2Feeds = ref([
  { name: 'macos_data_feed.json', url: '/data/feeds/v2/macos_data_feed.json' },
  { name: 'ios_data_feed.json', url: '/data/feeds/v2/ios_data_feed.json' },
  { name: 'safari_data_feed.json', url: '/data/feeds/v2/safari_data_feed.json' },
  { name: 'tvos_data_feed.json', url: '/data/feeds/v2/tvos_data_feed.json' },
  { name: 'watchos_data_feed.json', url: '/data/feeds/v2/watchos_data_feed.json' },
  { name: 'visionos_data_feed.json', url: '/data/feeds/v2/visionos_data_feed.json' }
])

const v1Feeds = ref([
  { name: 'macos.json', url: '/data/feeds/v1/macos_data_feed.json' },
  { name: 'ios.json', url: '/data/feeds/v1/ios_data_feed.json' },
  { name: 'rss.xml', url: '/sofa-2.0/v1/rss_feed.xml' }
])
