...
import tvOSData from '/v1/tvos_data_feed.json'
import watchOSData from '/v1/watchos_data_feed.json'
import visionOSData from '/v1/visionos_data_feed.json'
...
const searchCve = () => {
  ...
  const macOSResults = searchInDataFeed(macOSData, searchRegex, 'macOS')
  const iOSResults = searchInDataFeed(iOSData, searchRegex, 'iOS')
  const tvOSResults = searchInDataFeed(tvOSData, searchRegex, 'tvOS')
  const watchOSResults = searchInDataFeed(watchOSData, searchRegex, 'watchOS')
  const visionOSResults = searchInDataFeed(visionOSData, searchRegex, 'visionOS')
