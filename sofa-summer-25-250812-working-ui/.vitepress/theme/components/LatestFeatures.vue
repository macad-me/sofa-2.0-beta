        ...
        <div class="grid-item">
          <div class="content-box">
            ...
            <div v-if="selectedVersionDetails" class="deferral-details-grid">
              <div v-for="days in [30, 60, 90]" :key="days" class="deferral-item">
...
import safariData from '@v1/safari_data_feed.json'
import essentialLinksData from '@v1/essential_links.json'
